...
list = [
    ...
    youtubeLink("https://www.youtube.com/watch?v=LUzsd0wU2T4", 1, " [Sub] 400일간의 식충식물 팔루다리움 제작 성장 과정 |400 Days Of Carnivorous Plant Paludarium Production Growth Process ", 2060),
    youtubeLink("https://www.youtube.com/watch?v=67BpxYvdnlI", 1, " Kajaktour Schlei ", 1728),
    youtubeLink("https://www.youtube.com/watch?v=7cOVubGtaB0", 1, " sketchbook tour, but mentally ill ", 1623)
]
